        ...
        <div className="card-body py-10 px-8">
          ...
          <div className="text-center mb-8">
            <div className="w-24 h-24 mx-auto bg-primary/5 rounded-full flex items-center justify-center mb-4 p-2">
                 ...
                 />
                 <span className="text-3xl font-bold text-primary absolute opacity-0">P</span>
            </div>
            <h2 className="text-2xl font-bold text-base-content">Selamat Datang</h2>
            <p className="text-sm text-base-content/60 mt-1">Silakan masuk ke akun Anda</p>
          </div>
          ...
          <div className="space-y-4">
            <div className="form-control">
              ...
              <label className="input input-bordered flex items-center gap-2 focus-within:input-primary transition-colors">
                ...
                <input 
                    type="text" className="grow" placeholder="Masukkan username" 
            ...
            <div className="form-control">
              ...
              <label className="input input-bordered flex items-center gap-2 focus-within:input-primary transition-colors">
                ...
                <input 
                    type="password" className="grow" placeholder="Masukkan password" 
          ...
          <div className="form-control mt-6">
            ...
            >
              {isLoading ? <><span className="loading loading-spinner loading-sm"></span> Memproses...</> : "Masuk"}
            </button>
          </div>
        </div>
