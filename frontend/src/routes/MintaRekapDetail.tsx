...
export default function MintaRekapDetail() {
  ...
  const handleShare = async () => {
    ...
    const shareData = {
      title: "Rekap Absensi",
      text: `Berikut adalah link rekap absensi untuk bulan ${localizeMonthToString(
        parseInt(bulan)
      )} 20${tahun}`,
      url: resultUrl,
    };
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (hostWithoutPort.includes(":")) {
        const [_hostWithoutPort] = host.split(":", 2);
        hostWithoutPort = _hostWithoutPort;
      }
      ...
      if (
        ...
        hostWithoutPort.startsWith("192")
      ) {
        scheme = "http://";
      }

      const hostWithScheme = scheme + host;
        ...
        <div className="max-w-xl w-full space-y-6">
          ...
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold text-base-content">
              {localizeMonthToString(parseInt(bulan))}{" "}
              <span className="text-primary">20{tahun}</span>
            </h1>
            <p className="text-base-content/60 text-sm mt-1">
              Unduh atau bagikan laporan kehadiran siswa.
            </p>
          </div>
            ...
            {!resultUrl && (
              <div className="card-body items-center text-center py-10">
                ...
                <p className="text-sm text-base-content/60 mb-6">
                  Klik tombol di bawah menghasilkan laporan
                </p>
                <button
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className="w-5 h-5 -rotate-45 translate-y-0.5 translate-x-0.5"
                    >
