      ...
      <div className="card bg-base-100 shadow-sm border border-base-300 overflow-hidden">
        <div className="flex flex-col">
          ...
          <div
            ...
            className="flex cursor-pointer items-center gap-3 p-4 hover:bg-base-200 transition-colors border-b border-base-200"
          >
          ...
          <button
            ...
            className="flex cursor-pointer items-center gap-3 p-4 hover:bg-red-50 transition-colors text-left text-error group"
          >
